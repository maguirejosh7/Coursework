...
public class Layer2Frame
{
	...
	// System.out.println("bits now = " + bits);
	if (! computeParity(bits, 8).equals(parity)) {
     ...
     * bits in the string and return the result as a 0-padded bit String of the
     * given length.  The code mods the value to fit in the given length.
     */
    public static String computeParity(String bits, int len)
    {
	int ones = 0;
	...
	return toBinary(ones % (int) java.lang.Math.pow(2, len), len);
    }
