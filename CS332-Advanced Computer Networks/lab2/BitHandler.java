...
public class BitHandler extends Thread
{
     ...
     */
    public void broadcastOne() throws CollisionException //(if there is one)
    {
    	if(panel.isOn()){
    		panel.switchOff();
    	}
     ...
     */
    public void broadcast(String bits) throws CollisionException //throws one because it calls broadcastOne/Zero, which throws one
    {
