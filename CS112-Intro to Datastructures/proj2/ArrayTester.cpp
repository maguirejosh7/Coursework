 ...
 * The first three letters of the alphabet ARRAY, B, and C.
...
void ArrayTester::runTests() {
	...
	testConcat();
	testPuns();
	cout << "All tests passed!...with flying NYAN CATS!!!" << endl;
	cout << "____━━____┓━╭━━━━━╮				"<< "____━━____┓━╭━━━━━╮				"<< "____━━____┓━╭━━━━━╮				"<< endl;
	cout << "____━━____┗┓|::::::/^━━━^_			"<< "____━━____┗┓|::::::/^━━━^_			"<< "____━━____┗┓|::::::/^━━━^_			"<< endl;
	cout << "____━━____━┗|:::::|｡◕‿‿◕｡|			"<< "____━━____━┗|:::::|｡◕‿‿◕｡|			"<< "____━━____━┗|:::::|｡◕‿‿◕｡|			"<< endl;
	cout << "____━━____━━╰O-O----O-O				"<< "____━━____━━╰O-O----O-O				"<< "____━━____━━╰O-O----O-O			"<< endl;
}
...
void ArrayTester::testResize() {
	...
	setup();//makes a 1,2,3
	double * temp1 = a1;//makes new pointer the same as a1
...
void ArrayTester::testRead() {
	...
	assert( fin.is_open() );
	string firstline;
	getline(fin, firstline);      // skip past '6' that's there for fill()...
	read(fin, a4, 6);
	for (int i = 0; i < 6; i++) {
		assert( a4[i] == i+10 );
	}
...
void ArrayTester::testPuns(){
	cout << "Testing puns..." << flush;
	cout << "  Boy, it;s pretty ARRAY in here.. We better open a window." << endl;
	cout << "Spiderman loves mARRAY Jane." << endl;
	cout << "This program is almost done testing, hARRAYyyyy!!!!" << endl;
	cout << "Are you a size 5, ARRAY size 17?" << endl;
	cout << "Passed!" << endl;
