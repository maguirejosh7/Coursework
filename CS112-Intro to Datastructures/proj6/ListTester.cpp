...
{
cout << "testing sort() method..." << flush;
List<double> tList;
tList.sort();//empty list. sort method just returns without sorting(line 448 in list.h)
cout << "1.." << flush;
tList.append(55);
tList.append(99);
tList.append(33);
tList.append(77);
tList.append(11);
tList.sort();//example numbers
assert(tList.getFirst()==11);
assert(tList.getLast()==99);
assert(tList.getIndexOf(11) == 1);
assert(tList.getIndexOf(33) == 2);
assert(tList.getIndexOf(55) == 3);
assert(tList.getIndexOf(77) == 4);
//last one assumed
cout << "2.." << flush;
List<int> tList2;
tList2.append(9);
...
tList2.append(1);
tList2.append(0);
tList2.sort();//reverse order
assert(tList2.getIndexOf(0) == 1);
assert(tList2.getIndexOf(1) == 2);
assert(tList2.getIndexOf(2) == 3);
assert(tList2.getIndexOf(4) == 4);
assert(tList2.getIndexOf(7) == 5);
assert(tList2.getIndexOf(8) == 6);
cout << "3.." << flush;
List<double> tList3;
tList3.append(1);
tList3.append(2);
...
tList3.append(5);
tList3.append(3);
tList3.sort();//last number gets sorted
assert(tList3.getIndexOf(1)==1);
assert(tList3.getIndexOf(2)==2);
assert(tList3.getIndexOf(3)==3);
assert(tList3.getIndexOf(4)==4);
cout << "4.." << flush;
List <int> tList4;
tList4.append(6);
tList4.sort();//list size 1 (doesn't actually get sorted)
tList4.append(5);
tList4.sort();//list size 2
assert(tList4.getFirst()==5);
tList4.append(6);
tList4.sort();//what if theres 2 of the same number...
assert(tList4.getIndexOf(6)==2);//it still works.
cout << "5.." << flush;
List<double> tList5;//random
tList5.append(3);
tList5.append(7);
tList5.append(2);
tList5.append(9);
...
tList5.append(1);
tList5.sort();
assert(tList5.getIndexOf(1)==1);
assert(tList5.getIndexOf(2)==2);
assert(tList5.getIndexOf(3)==3);
assert(tList5.getIndexOf(7)==4);
assert(tList5.getIndexOf(8)==5);
cout << "6.." << flush;
cout << "passed!" << endl;
}
